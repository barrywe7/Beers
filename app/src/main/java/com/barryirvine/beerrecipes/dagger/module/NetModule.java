...
public class NetModule {
	...
	@Provides
	@Singleton
	BeersAPI provideBeersAPI(final Gson gson, final OkHttpClient okHttpClient) {
	...
	@Provides
	@Singleton
	Picasso providePicasso(final Application application, final OkHttp3Downloader okHttp3Downloader) {
